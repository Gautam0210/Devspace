    ...
    <html>
        ...
        <body>
            <section>
                <div class="container">
                    <div class="left">
                        <h1>You have successfully deployed this project with<img class="logo" src="https://static.loft.sh/branding/logos/devspace/horizontal/mono/devspace_horizontal_mono.svg" alt="DevSpace" /></h1>
